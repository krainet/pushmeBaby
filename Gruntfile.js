module.exports = function (grunt) {
    ...
    grunt.registerTask('build', [
        ...
        'concat:build_css', 'copy:build_app_assets', 'copy:build_app_fonts', 'copy:build_vendor_assets', 'copy:extra_templates',
    ...
    grunt.registerTask('compile', [
        'less:compile', 'copy:compile_assets','copy:build_app_fonts', 'copy:extra_templates', 'concat:compile_js', 'uglify', 'index:compile'
    ]);
    ...
    grunt.registerMultiTask('index', 'Process index.html template', function () {
        ...
        var cssCdnFiles = grunt.config('vendor_files.css_cdn');
